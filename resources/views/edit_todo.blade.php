       ...
       <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="POST" action="{{ route('todo.update') }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group row">
                                ...
                                <textarea name="decription" id="description" cols="30" rows="10" class="form-control @error ('password') is-invalid @enderror" autocomplete="description" value="{{ $todo->description }}"></textarea>
                                @error
                            ...
                            <div class="form-group row">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="completed" value=" {{ $todo->completed}}">
